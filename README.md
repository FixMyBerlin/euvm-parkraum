...
1. translation_innenstadt.py/translation_aussenstadt.py nimmt die eUVM-Polygone und übersetzt deren Attribute in OSM-Tags (inkl. parsing von Parkbeschränkungen).
